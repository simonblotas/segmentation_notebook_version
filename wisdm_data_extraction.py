import numpy as np
from main_constants import SIGNAL_LENGHT, WISDM_FOLDER_PATH, WISDM_MIN_LENGHT

# Open the text file in read mode
wisdm_file_path = WISDM_FOLDER_PATH
...
def load_wisdm():
    ...
    with open(wisdm_file_path, "r") as file:
    ...
    return wisdm_signals, wisdm_segmentations
