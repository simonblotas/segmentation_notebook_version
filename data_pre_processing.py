...
from main_constants import SIGNAL_LENGHT
...
def segmentations_pre_process(
    segmentations: List[List[int]], transformed_signal_size: int
    ...
    np_segmentations = np.zeros((len(segmentations), SIGNAL_LENGHT))
    stride = int(SIGNAL_LENGHT / transformed_signal_size)
    ...
    for i in range(len(segmentations)):
        np_segmentations[i] = get_segment_ids(np.array(segmentations[i]), SIGNAL_LENGHT)
